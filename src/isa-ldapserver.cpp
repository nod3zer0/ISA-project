...
int main(int argc, const char *argv[]) {
  ...
  BerSequenceObject *application1 = new BerSequenceObject(BER_BIND_RESPONSE_C);
...
//   (char *)&sa, sizeof(sa)); if (returnCode < 0) {
...
//   sa.sin6_port = htons(10015);
//   if ((returnCode =
//            bind(communicationSocket, (struct sockaddr *)&sa, sizeof(sa))) <
//            0) {
//     perror("bind() failed");
//     exit(EXIT_FAILURE);
//   }
...
//   {
//     int commSocket =
//         accept(communicationSocket, (struct sockaddr *)&clientSA,
//         &ClientSALen);
